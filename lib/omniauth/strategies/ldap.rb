  ...
  module Strategies
    class LDAP
      ...
      def callback_phase
        ...
        raise MissingCredentialsError.new("Missing login credentials") if request['username'].nil? || request['password'].nil? || request['username'].empty? || request['password'].empty?
        begin
